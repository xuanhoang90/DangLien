...
<div class="trangchuquantri">
	<div class="init">
		...
		<div class="quickstart">
			...
			<p class="title"><a href="<?php echo ROOT_DOMAIN."/?site=admin";?>">Admin</a> <i class="fa fa-angle-double-right"></i> <a href="<?php echo ROOT_DOMAIN."/?site=admin&view=member&action=unactive_user&page_number=1";?>"> Danh sach user chua kich hoat</a> </p>
			<div class="app-icon">
				<?php if($memberList): 
						...
						?>
							<div class="row">
								...
								<div class="table_thaotac" style="width: 30%;">
									<a class="thaotac kichhoat" href="<?php echo ROOT_DOMAIN."/?site=admin&view=member&action=unactive_user_active&user_id=".$oneMem['id'];?>"><i class="fa fa-edit"></i> Kich hoat</a>
			...
			<script>
				$(function(){
					//kich hoat user
					$(".unactive_user").find(".row").find('.table_thaotac').find(".kichhoat").click(function(e){
						e.preventDefault();
						if(confirm("Ban co chac muon kich hoat khong?")){
